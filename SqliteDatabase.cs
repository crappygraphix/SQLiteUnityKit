...
public class SqliteDatabase
{
	...
	/// The db file is automatically copied to Application.persistenDataPath.
	/// </summary>
	/// <param name='dbName'> 
	/// Data Base name. (the file needs exist in the streamingAssets)
	/// </param>
	...
	/// </summary>
	/// <param name='path'> 
	/// Path to the db file. (the file needs exist in Application.dataPath)
	/// </param>
	public static SqliteDatabase FromAssetPath(string path) {
		var db = new SqliteDatabase ();
		db.pathDB = System.IO.Path.Combine (Application.dataPath, path);
		return db;
	}
